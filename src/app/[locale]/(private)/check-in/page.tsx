...
export default function CheckInHistory() {
  ...
  const getFilteredCheckIns = () => {
    ...
    switch (currentTab) {
      ...
      case "eventos":
        ...
        return Object.values(eventGroups).map(
          (group) =>
            group.sort(
              (a, b) =>
  ...
  if (loading) {
    return (
      <div className="flex h-full flex-col items-center justify-center p-4 bg-white">
      ...
      >
        ...
        <Card className="bg-white shadow-sm border mb-6">
          <CardHeader className="pb-2">
            ...
            <CardDescription>Registro de suas participações</CardDescription>
          </CardHeader>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Última presença em{" "}
            {format(new Date(checkIn.createdAt), "dd/MM/yyyy")}
          </p>
        </div>
      </div>
      ...
      <div className="mt-2 pt-2 border-t border-gray-200">
        <div className="flex justify-between items-center text-xs text-gray-600">
          <div className="flex items-center">
            ...
            <span>
              Dia frequente: {getWeekdayName(checkIn.prayerTurn.weekday)}
            </span>
          </div>
